...
define('extensions/aura-backbone-layoutmanager',['backbone','layoutmanager'],function() {
  return function(app) {
    var _ = app.core.util._;
...
define('extensions/aura-backbone',['backbone'],function() {
  return function(app) {
    var _ = app.core.util._;
    var historyStarted = false;
    var Backbone;
...
define('text!aura_components/app/app.html',[],function () { return '<div class="navbar navbar-inverse navbar-fixed-top">\r\n    <div class="navbar-inner">\r\n        <div class="container-fluid">\r\n            <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">\r\n                <span class="icon-bar"></span>\r\n                <span class="icon-bar"></span>\r\n                <span class="icon-bar"></span>\r\n            </button>\r\n            <a class="brand" href="#">aura.youtube</a>\r\n\r\n            <div class="nav-collapse collapse">\r\n                <p class="navbar-text pull-right">\r\n                    Logged in as <a href="#" class="navbar-link">Username</a>\r\n                </p>\r\n                <ul class="nav">\r\n                    <li class="active"><a href="#">Home</a></li>\r\n                    <li><a href="#search">Search</a></li>\r\n                    <li><a href="#contact">Contact</a></li>\r\n                </ul>\r\n            </div>\r\n            <!--/.nav-collapse -->\r\n        </div>\r\n    </div>\r\n</div>\r\n\r\n<div class="container-fluid">\r\n    <div class="row-fluid">\r\n        <div class="span2">\r\n            <div class="well sidebar-nav">\r\n                <ul class="nav nav-list">\r\n                    <li class="nav-header">Sidebar</li>\r\n                    <li><a href="#">Home</a></li>\r\n                    <li><a href="#search">Search</a></li>\r\n                    <li><a href="#contact">Contact</a></li>\r\n                </ul>\r\n                <ul class="nav nav-list">\r\n                    <li class="nav-header">Recent Videos</li>\r\n                </ul>\r\n                <div data-aura-widget="recentVideos"></div>\r\n            </div>\r\n            <!--/.well -->\r\n        </div>\r\n        <!--/span-->\r\n        <div class="span10">\r\n            <div class="row-fluid">\r\n                <div class="span12">\r\n                    <h2>aura.youtube</h2>\r\n\r\n                    <div id="mainContent">\r\n                        <div data-aura-widget="home"></div>\r\n                    </div>\r\n                </div>\r\n                <!--/span-->\r\n\r\n            </div>\r\n            <!--/row-->\r\n        </div>\r\n        <!--/span-->\r\n    </div>\r\n    <!--/row-->\r\n\r\n    <hr>\r\n\r\n    <footer>\r\n        <p>&copy; Company 2013</p>\r\n    </footer>\r\n\r\n</div>\r\n\r\n';});

define('text!aura_components/app/home.html',[],function () { return '<div data-aura-widget="home"></div>';});

define('text!aura_components/app/contact.html',[],function () { return '<div data-aura-widget="contact"></div>\r\n';});

define('text!aura_components/app/search.html',[],function () { return '<div data-aura-widget="searchBar"></div>\r\n<div data-aura-widget="searchResults" data-aura-params=\'{ "searchTerm" : "{{id}}" }\'></div>';});

define('text!aura_components/app/nowplaying.html',[],function () { return '<div class="search" data-aura-widget="searchBar"></div>\r\n\r\n<div style="clear: both">\r\n    <div style="float:left;width:600px;">\r\n        <div class=\'nowPlaying\' data-aura-widget="nowPlaying" data-aura-params=\'{ "video" : "{{id}}" }\'></div>\r\n        <div class=\'comments\' data-aura-widget="comments"></div>\r\n    </div>\r\n    <div style="float:left; margin-left:15px;width:300px;" class="related" data-aura-widget="relatedVideos"></div>\r\n</div>\r\n';});

define('aura_components/app/router',['require','backbone'],function (require) {
 ...
 */
define('__component__$app@default',['require','text!./app.html','text!./home.html','text!./contact.html','text!./search.html','text!./nowplaying.html','aura_components/app/router'],function (require) {
 ...
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/comments/collection',['require','backbone'],function (require) {
...
define('__component__$comments@default',['require','aura_components/comments/itemView','aura_components/comments/collection'],function (require) {
...
define('text!aura_components/contact/contact.html',[],function () { return '<img src="{{avatar}}" class="img-polaroid" style="float: left; margin-right:15px;">\r\n<div style="float:left; width: 800px;">\r\n    <h3>Tim Doherty</h3>\r\n\r\n    <p>I\'m a software engineer, avid SCUBA diver, amateur underwater photographer, and occasional musician living in\r\n        southern California. My passion is solving problems and building things with technology.</p>\r\n\r\n    <ul class="unstyled"></ul>\r\n</div>';});

define('text!aura_components/contact/link.html',[],function () { return '<a class="btn btn-small" href="{{url}}" target="{{target}}">{{text}}</a>';});

/**
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/contact/contactLink',['require','backbone','text!./link.html'],function (require) {
...
define('__component__$contact@default',['require','text!./contact.html','aura_components/contact/contactLink'],function (require) {
...
define('text!aura_components/home/home.html',[],function () { return '<h3>Aura.js Youtube Demo</h3>\r\n<p>\r\n    This is a demo created with <a href="http://aurajs.github.io/aura/" target="_blank">Aura.js</a>,\r\n    a "clean and scalable architecture for complex JavaScript applications."\r\n\r\n</p>\r\n<p>The demo is a mimic of Youtube\'s search/now playing pages, start <a href="#/search">searching</a> and try it out.</p>';});

/**
 * simple widget for home page
 */
define('__component__$home@default',['require','text!./home.html'],function (require) {
...
define('text!aura_components/now_playing/main.html',[],function () { return '<iframe width="560" height="386"\r\n        src="http://www.youtube.com/embed/{{source}}?html5=1&theme=dark&showinfo=0&modestbranding=1&controls=1&autoplay=0"\r\n        allowfullscreen style="border: 1px solid black;"></iframe>\r\n<h4>{{title.$t}}</h4>';});

/**
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/now_playing/model',['require','backbone'],function (require) {
...
define('__component__$now_playing@default',['require','text!./main.html','aura_components/now_playing/model'],function (require) {
...
define('text!aura_components/recent_videos/item.html',[],function () { return '<a href=\'#/nowplaying/{{source}}\'>\r\n    <span class="ux-thumb-wrap">\r\n        <span class="video-thumb ux-thumb yt-thumb-default-120 ">\r\n            <span class="yt-thumb-clip">\r\n                <span class="yt-thumb-clip-inner">\r\n                    <img width="120" alt="Thumbnail" src="{{media$group.media$thumbnail[1].url}}" >\r\n                    <span class="vertical-align">\r\n                </span>\r\n                </span>\r\n            </span>\r\n        </span>\r\n        <span class="video-time">{{duration}}</span>\r\n    </span>\r\n    <span class="title" title="{{title.$t.substr(0, 30)}}">{{title.$t.substr(0, 20)}}</span>\r\n    <span class="stat">by {{author[0].name.$t}}</span>\r\n    <span class="stat"> {{yt$statistics.viewCount}} views </span>\r\n</a>\r\n';});

/**
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/recent_videos/itemView',['require','backbone','text!./item.html'],function (require) {
...
define('__component__$recent_videos@default',['require','aura_components/recent_videos/itemView'],function (require) {
...
define('text!aura_components/related_videos/item.html',[],function () { return '<a href=\'#/nowplaying/{{source}}\'>\r\n    <span class="ux-thumb-wrap">\r\n        <span class="video-thumb ux-thumb yt-thumb-default-120 ">\r\n            <span class="yt-thumb-clip">\r\n                <span class="yt-thumb-clip-inner">\r\n                    <img width="120" alt="Thumbnail" src="{{media$group.media$thumbnail[1].url}}" >\r\n                    <span class="vertical-align">\r\n                </span>\r\n                </span>\r\n            </span>\r\n        </span>\r\n        <span class="video-time">{{duration}}</span>\r\n    </span>\r\n    <span class="title" title="{{title.$t.substr(0, 30)}}">{{title.$t.substr(0, 20)}}</span>\r\n    <span class="stat">by {{author[0].name.$t}}</span>\r\n    <span class="stat"> {{yt$statistics.viewCount}} views </span>\r\n</a>\r\n';});

/**
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/related_videos/itemView',['require','backbone','text!./item.html'],function (require) {
 ...
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/related_videos/collection',['require','backbone'],function (require) {
 ...
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/related_videos/model',['require','backbone'],function (require) {
...
define('__component__$related_videos@default',['require','aura_components/related_videos/itemView','aura_components/related_videos/collection','aura_components/related_videos/model'],function (require) {
...
define('text!aura_components/search_bar/main.html',[],function () { return '<div class="control-group">\r\n    <div class="controls">\r\n        <div class="input-append">\r\n            <input id="searchTerm" type="text" name="searchTerm">\r\n            <span class="add-on btn" id="searchBtn"><i class="icon-search"></i></span>\r\n        </div>\r\n    </div>\r\n</div>';});

/**
 * Search bar model
 */
define('aura_components/search_bar/model',['require','backbone'],function (require) {
 ...
 */
define('__component__$search_bar@default',['require','text!./main.html','aura_components/search_bar/model','modelBinder'],function (require) {
...
define('text!aura_components/search_results/main.html',[],function () { return '<div class="primary-col">\r\n    <ul class="unstyled">\r\n\r\n    </ul>\r\n</div>';});

define('text!aura_components/search_results/item.html',[],function () { return '<div>\r\n    <div class="yt-lockup2-thumbnail">\r\n        <a class="ux-thumb-wrap yt-uix-sessionlink yt-uix-contextlink contains-addto" href="#/nowplaying/{{source}}">\r\n            <span class="video-thumb ux-thumb yt-thumb-default-185 ">\r\n                <span class="yt-thumb-clip">\r\n                    <span class="yt-thumb-clip-inner">\r\n                        <img width="185" src="{{media$group.media$thumbnail[0].url }}" alt="Thumbnail">\r\n                        <span class="vertical-align"></span>\r\n                    </span>\r\n                </span>\r\n            </span>\r\n            <span class="video-time">{{duration }}</span>\r\n        </a>\r\n    </div>\r\n\r\n    <div class="yt-lockup2-content">\r\n        <h5 class="yt-lockup2-title" style="margin:0;">\r\n            <a href="#/nowplaying/{{source}}" title="{{title.$t }}">{{title.$t }}</a>\r\n        </h5>\r\n\r\n        <p class="yt-lockup2-meta"> by <strong>{{author[0].name.$t }}</strong>\r\n            <span class="metadata-separator">•</span>\r\n            1 year ago\r\n            <span class="metadata-separator">•</span>\r\n            {{yt$statistics.viewCount }} views\r\n        </p>\r\n\r\n        <p dir="ltr" class="yt-lockup2-description">{{media$group.media$description.$t.substr(0, 50) }}</p>\r\n\r\n        <div class="yt-lockup2-badges">\r\n            <ul class="item-badge-line">\r\n                <li class="item-badge-label ">HD</li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</div>';});

/**
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/search_results/itemView',['require','text!./item.html'],function (require) {
 ...
 * RequireJS Module Definition - AMD 'sugar' syntax
 */
define('aura_components/search_results/collection',['require','backbone'],function (require) {
 ...
 * Search Result model
 */
define('aura_components/search_results/model',['require','backbone'],function (require) {
 ...
 * - uses extensions/aura-backbone for an integrated Backbone View widget
 */
define('__component__$search_results@default',['require','text!./main.html','aura_components/search_results/itemView','aura_components/search_results/collection','aura_components/search_results/model'],function (require) {
